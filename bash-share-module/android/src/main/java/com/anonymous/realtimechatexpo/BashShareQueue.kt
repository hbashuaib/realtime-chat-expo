...
object BashShareQueue {
  ...
  @JvmStatic fun consume(): String? {
      ...
      if (v != null) {
          ...
          android.util.Log.e("BashChatTest", ">>> BashShareQueue consume cleared, value=$v")
      }
      return v
  }
  ...
  @JvmStatic fun getPending(): String? {
      val v = getPrefs().getString(KEY_PENDING, null)
      android.util.Log.e("BashChatTest", ">>> BashShareQueue getPending: $v")
      return v
  }

  @JvmStatic fun clearPending(): Boolean {
      val hadValue = getPrefs().getString(KEY_PENDING, null) != null
      getPrefs().edit().remove(KEY_PENDING).apply()
      android.util.Log.e("BashChatTest", ">>> BashShareQueue clearPending, hadValue=$hadValue")
      return hadValue
  }
